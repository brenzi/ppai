...
val buildNativeLibs by tasks.registering(Exec::class) {
    ...
    val goSource = project.file("../privatemode-public/privatemode-proxy/libprivatemode")
...
android {
    namespace = "ch.brenzi.prettyprivateai"
    compileSdk = 35

    defaultConfig {
        applicationId = "ch.brenzi.prettyprivateai"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
